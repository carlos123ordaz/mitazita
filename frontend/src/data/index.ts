...
export const MUG_MODELS: MugModel[] = [
  {
    id: 'clasica',
    name: 'Clásica',
  ...
  },
  {
    ...
    rim: '#e0a8b6',
    interiorTint: '#e0a8b6',
    imageUrl: '/images/interior_rosa.png',
  },
  {
    id: 'dorada',
    name: 'Borde Dorado',
    ...
    rim: '#c9a472',
    handleColor: '#c9a472',
    imageUrl: '/images/borde_dorado.png',
  },
  {
    id: 'jumbo',
    name: 'Jumbo 15oz',
...
export const EXTRAS: Extra[] = [
  ...
  { id: 'delivery', label: 'Delivery Lima 24h', desc: 'Express puerta a puerta', price: 6 },
];
