import type { MugModel } from '../data';
      ...
      <g transform={`translate(160 140) scale(${scale}) translate(-160 -140)`}>
        ...
        {showPhoto && (
          <g clipPath={`url(#clip-${model.id})`}>
            {photoUrl ? (
              <image href={photoUrl} x="60" y="60" width="180" height="160" preserveAspectRatio="xMidYMid slice" />
            ) : (
              <g>
                ...
                <text
                  x="150" y="140" textAnchor="middle" fontSize="9"
                  fontFamily="ui-monospace, Menlo, monospace"
                  fill={isDark ? '#a89890' : '#9b8a82'}
                >
                  [ tu foto aquí ]
                </text>
              </g>
